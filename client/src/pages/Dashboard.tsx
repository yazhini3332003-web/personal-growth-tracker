  ...
  if (!activeGoal) {
    return (
      <div className="text-center py-20">
        ...
        <a
          href="/goals"
          className="inline-flex items-center px-6 py-3 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition font-medium shadow-lg shadow-primary-200"
        >
