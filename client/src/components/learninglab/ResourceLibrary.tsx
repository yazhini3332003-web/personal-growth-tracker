...
const typeIcons: Record<string, React.ReactNode> = {
  ...
  github: <FiGithub className="text-gray-300" />,
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-gray-700 text-white text-sm rounded-lg pl-9 pr-3 py-2 border border-gray-600 focus:border-indigo-500 focus:outline-none"
            />
          </div>
          ...
          <select
            ...
            className="bg-gray-700 text-white text-sm rounded-lg px-3 py-2 border border-gray-600 sm:w-56"
          >
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          {(["all", "tutorial", "docs", "blog", "github", "video"] as ResourceType[]).map((type) => (
            ...
            >
              ...
              <span className="text-gray-400 ml-1">({typeCounts[type] || 0})</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((resource, i) => (
          <a
            ...
            className="bg-gray-800 rounded-xl border border-gray-700 p-4 hover:border-indigo-500/50 transition-all duration-200 group"
          >
            {/* Type badge */}
            <div className="flex items-center justify-between mb-3">
              ...
              <FiExternalLink className="text-gray-500 group-hover:text-indigo-400 transition-colors" size={12} />
            </div>
