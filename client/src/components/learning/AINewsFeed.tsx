          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1">
                ...
                <span className="text-xs text-gray-400 mt-2 inline-block">Source: {item.source}</span>
              </div>
              <span className="text-gray-300 group-hover:text-blue-500 transition text-xl mt-2">↗</span>
            </div>
          </a>
        ))}
      </div>
